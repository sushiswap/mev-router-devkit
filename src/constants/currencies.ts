...
export const GoerliWeth = new Token(
  ChainId.Goerli,
  WETH[ChainId.Goerli],
...
export const GoerliWrappedBitcoin = new Token(
  ChainId.Goerli,
  WBTC[ChainId.Goerli],
  'Wrapped Bitcoin',
  'WBTC',
...
export const GoerliTetherUSD = new Token(
  ChainId.Goerli,
  USDT[ChainId.Goerli],
  'Tether USD',
  'USDT',
...
export const GoerliDai = new Token(
  ChainId.Goerli,
  DAI[ChainId.Goerli],
  'Dai Stablecoin',
  'DAI',
...
export const GoerliLink = new Token(
  ChainId.Goerli,
  LINK[ChainId.Goerli],
  'ChainLink Token',
  'LINK',
...
export const GoerliCrv = new Token(
  ChainId.Goerli,
  CRV[ChainId.Goerli],
  'Curve DAO Token',
  'CRV',
...
export const GoerliSushi = new Token(
  ChainId.Goerli,
  SUSHI[ChainId.Goerli],
  'SushiToken',
  'SUSHI',
  18,
);
...
export const GanacheWeth = new Token(
  ChainId.Ganache,
  WETH[ChainId.Ganache],
  'Wrapped Ganache Ether',
  'WETH',
  18,
);
...
export const GanacheUSDCoin = new Token(
  ChainId.Ganache,
  USDC[ChainId.Ganache],
  'Ganache USD Coin',
  'USDC',
  6,
);
export const GanacheTetherUSD = new Token(
  ChainId.Ganache,
  USDT[ChainId.Ganache],
  'Ganache Tether USD',
  'USDT',
  6,
);
export const GanacheDai = new Token(
  ChainId.Ganache,
  DAI[ChainId.Ganache],
  'Ganache Dai',
  'DAI',
...
export const GanacheLink = new Token(
  ChainId.Ganache,
  LINK[ChainId.Ganache],
  'Ganache ChainLink',
  'LINK',
  18,
);
export const GanacheCrv = new Token(
  ChainId.Ganache,
  CRV[ChainId.Ganache],
  'Ganache Curve DAO Token',
  'CRV',
  18,
);
